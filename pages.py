...
class UrbanRoutesPage:
    ...
    add_card = (By.CSS_SELECTOR, '.pp-title')
    ...
    switch_blanket = (By.CSS_SELECTOR, 'input[type="checkbox"]')  # Better selector
    switch_blanket_active = (By.CSS_SELECTOR, 'input[type="checkbox"]:checked')

    add_icecream = (By.CSS_SELECTOR, '.counter-plus')
    qnt_icecream = (By.CSS_SELECTOR, '.counter-value')
    call_taxi_button = (By.CSS_SELECTOR, '.smart-button.secondary')
